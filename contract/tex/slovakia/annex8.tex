...
\end{center}
	...
	\item For each subsequent year of the Service Period the Operation and Maintenance Fee shall be subject to a revision based on the Latvian Consumer Price Index, published by the Central Statistical Bureau (Centrala statistikas parvalde) to reflect the following general principle:
